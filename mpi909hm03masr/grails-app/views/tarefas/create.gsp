...
<html>
	...
	<body>
		<a href="#create-tarefas" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-tarefas" class="content scaffold-create" role="main">
